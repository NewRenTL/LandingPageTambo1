  ...
  return (
    <div className="w-full flex flex-col md:flex-row justify-center items-center my-2">
      ...
      <div className="w-full flex flex-col md:w-4/12 h-[300px] justify-start items-center p-8 border-r">
        ...
        <h3 className="my-2 font-semibold text-center underline underline-offset-1 decoration-stone-500 font-hurme3">Legales</h3>
        <h3 className="my-2 font-semibold text-center underline underline-offset-1 decoration-stone-500 font-hurme3">Términos y Condiciones de Uso</h3>
        <h3 className="my-2 font-semibold text-center underline underline-offset-1 decoration-stone-500 font-hurme3">Política de Privacidad</h3>
        <h3 className="my-2 font-semibold text-center underline underline-offset-1 decoration-stone-500 font-hurme3">Política de Cookies</h3>
      </div>
