  ...
  return (
    <div className="w-full flex flex-col">
      <div className="w-full flex flex-col md:flex-row">
        ...
        <div className="w-full flex px-24 py-24  flex-col md:w-[50%]  text-[#F3E82A] bg-[#B22B89]">
          <div className="w-full my-8 flex ">
            <h2 className="font-futuraFont lg:text-5xl">INNOVACIÓN Y PREFERENCIA DE COMPRA</h2>
          </div>
          <div className="w-full mb-8 flex font-hurme3 lg:text-xl">
            <p>
              ...
              acogedor que atrae a los clientes
            </p>
          </div>
        </div>
      </div>
      <div className="w-full flex flex-col md:flex-row">
        <div className="w-full flex px-16 py-12 flex-col md:w-[50%] text-[#B22B89] bg-[#F3E82A]">
          <div className="w-full my-8 flex">
            <h2 className="font-futuraFont lg:text-5xl">COMPROMISO CON LA COMUNIDAD</h2>
          </div>
          <div className="w-full mb-8 flex font-hurme3 lg:text-xl">
            <p>
